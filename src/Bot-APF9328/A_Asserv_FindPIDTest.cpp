#include "A_Asserv_FindPIDTest.hpp"
...
void A_Asserv_FindPIDTest::configureConsoleArgs(int argc, char** argv) //surcharge
{
...
void A_Asserv_FindPIDTest::run(int argc, char** argv)
{
