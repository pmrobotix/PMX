...
void A_AsservInsaTest::configureConsoleArgs(int argc, char** argv) //surcharge
{
...
void A_AsservInsaTest::run(int argc, char** argv)
{
	logger().info() << "Executing - " << this->desc() << logs::end;
	configureConsoleArgs(argc, argv);

	utils::Chronometer chrono("A_AsservInsaTest");
	long left;
	long right;
