...
void L_Asserv_SquareTest::run(int argc, char** argv)
{
    ...
    robot.asserv().setPositionAndColor(0.0, 500.0, 0.0, (robot.getMyColor() != PMXVIOLET));
    ...
    for (int n = 1; n <= nb; n++) {
        ...
        logger().info() << "doMoveForwardTo time= " << chrono.getElapsedTimeInMilliSec() << "ms ; left= " << left
