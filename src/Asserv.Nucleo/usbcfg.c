...
// */
//static const uint8_t vcom_device_descriptor_data[18] = { USB_DESC_DEVICE(0x0110, /* bcdUSB (1.1).                    */
...
// */
//static const uint8_t vcom_string0[] = { USB_DESC_BYTE(4), /* bLength.                         */
...
//USB_DESC_BYTE(USB_DESCRIPTOR_STRING), /* bDescriptorType.                 */
//'S', 0, 'T', 0, 'M', 0, 'i', 0, 'c', 0, 'r', 0, 'o', 0, 'e', 0, 'l', 0, 'e', 0, 'c', 0, 't', 0, 'r', 0, 'o', 0, 'n', 0,
//        'i', 0, 'c', 0, 's', 0 };
//
///*
...
//USB_DESC_BYTE(USB_DESCRIPTOR_STRING), /* bDescriptorType.                 */
//'C', 0, 'h', 0, 'i', 0, 'b', 0, 'i', 0, 'O', 0, 'S', 0, '/', 0, 'R', 0, 'T', 0, ' ', 0, 'V', 0, 'i', 0, 'r', 0, 't', 0,
//        'u', 0, 'a', 0, 'l', 0, ' ', 0, 'C', 0, 'O', 0, 'M', 0, ' ', 0, 'P', 0, 'o', 0, 'r', 0, 't', 0 };
//
///*
...
//        { sizeof vcom_string1, vcom_string1 }, { sizeof vcom_string2, vcom_string2 }, { sizeof vcom_string3,
//                vcom_string3 } };
//
///*
...
//NULL, sduDataTransmitted, sduDataReceived, 0x0040, 0x0040, &ep1instate, &ep1outstate, 2,
//NULL };
//
///**
// * @brief   IN EP2 state.
...
//NULL, sduInterruptTransmitted,
//NULL, 0x0010, 0x0000, &ep2instate,
//NULL, 1,
//NULL };
//
