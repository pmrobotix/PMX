...
void AsservInsa::initMotor(MOTOR *motor) {
	int i;
...
//void AsservInsa::motors_ConfigAllIMax(int32 imax) {
//	int i, j;
...
void AsservInsa::updateMotor(MOTOR *motor, int32 delta) {
	//update position
	motor->lastPos += delta;
...
int32 AsservInsa::getMotorSpeed(MOTOR *motor) {
